              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Cost Share Officer</p>
                      <!-- <p class="fs-30 mb-2">5</p> -->
                      <?php
                                include('connection.php');
                                 $result=$con->query("SELECT count(*) as total from costsharing_officer");
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Accountant</p>
                     <?php include('connection.php');
                                 $result=$con->query("SELECT count(*) as total from accountant");
                                 $data=$result->fetch_assoc();
                                 $percent = $data['total'];
                                echo "<p class='fs-30 mb-2'>"; echo $percent;   echo"</p>";
                                ?>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      <p class="mb-4"> Registrar</p>
                      <?php include('connection.php');
                                 $result=$con->query("SELECT count(*) as total from registrar");
                                 $data=$result->fetch_assoc();
                                 $percent = $data['total'];
                                echo "<p class='fs-30 mb-2'>"; echo $percent;   echo"</p>";
                                ?>
