        ...
        <div class="content-wrapper">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">List of Students</span></h4>
              <div class="card">
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                       ...
                       $faculity= $row['faculity'];
                        ?>
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $fname; echo " "; echo $mname;echo " "; echo $lname;?></strong></td>
